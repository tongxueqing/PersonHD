...
class LPIPS():
    ...
    def calculate_from_disk(self, path_1, path_2,K,batch_size=64, verbose=False, sort=True):
        if sort:
...
if __name__ == "__main__":
    ...
    lpips_score = lpips.calculate_from_disk(args.distorated_path, args.gt_path, args.K,sort=False)
